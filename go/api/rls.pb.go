...
func (RateLimitResponse_Code) Descriptor() protoreflect.EnumDescriptor {
	return file_rls_proto_enumTypes[1].Descriptor()
}

func (RateLimitResponse_Code) Type() protoreflect.EnumType {
	return &file_rls_proto_enumTypes[1]
}
...
func (RateLimitResponse_Code) EnumDescriptor() ([]byte, []int) {
	return file_rls_proto_rawDescGZIP(), []int{1, 0}
}
...
func (RateLimitResponse_RateLimit_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_rls_proto_enumTypes[2].Descriptor()
}

func (RateLimitResponse_RateLimit_Unit) Type() protoreflect.EnumType {
	return &file_rls_proto_enumTypes[2]
}
...
func (RateLimitResponse_RateLimit_Unit) EnumDescriptor() ([]byte, []int) {
	return file_rls_proto_rawDescGZIP(), []int{1, 0, 0}
}
...
func (x *RateLimitRequest) GetDescriptors() []*RateLimitDescriptor {
	if x != nil {
...
type RateLimitResponse struct {
	...
	RequestHeadersToAdd []*HeaderValue `protobuf:"bytes,4,rep,name=request_headers_to_add,json=requestHeadersToAdd,proto3" json:"request_headers_to_add,omitempty"`
...
func (x *RateLimitResponse) GetResponseHeadersToAdd() []*HeaderValue {
	if x != nil {
...
func (x *RateLimitResponse) GetRequestHeadersToAdd() []*HeaderValue {
	if x != nil {
...
func (*HeaderValue) Descriptor() ([]byte, []int) {
	return file_rls_proto_rawDescGZIP(), []int{2}
}
...
func (*RateLimitDescriptor) Descriptor() ([]byte, []int) {
	return file_rls_proto_rawDescGZIP(), []int{3}
}
...
func (*RateLimitResponse_Quota) Descriptor() ([]byte, []int) {
	return file_rls_proto_rawDescGZIP(), []int{1, 1}
}
...
func (*RateLimitResponse_DescriptorStatus) Descriptor() ([]byte, []int) {
	return file_rls_proto_rawDescGZIP(), []int{1, 2}
}
...
func (*RateLimitDescriptor_Entry) Descriptor() ([]byte, []int) {
	return file_rls_proto_rawDescGZIP(), []int{3, 0}
}
...
type RateLimitDescriptor_RateLimitOverride struct {
	...
	RequestsPerUnit uint32 `protobuf:"varint,1,opt,name=requests_per_unit,json=requestsPerUnit,proto3" json:"requests_per_unit,omitempty"`
	// The unit of time.
	Unit          RateLimitUnit `protobuf:"varint,2,opt,name=unit,proto3,enum=envoy.service.ratelimit.v3.RateLimitUnit" json:"unit,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*RateLimitDescriptor_RateLimitOverride) Descriptor() ([]byte, []int) {
	return file_rls_proto_rawDescGZIP(), []int{3, 1}
}
...
func (x *RateLimitDescriptor_RateLimitOverride) GetUnit() RateLimitUnit {
	if x != nil {
		return x.Unit
	}
...
const file_rls_proto_rawDesc = "" +
	"\n" +
	"\trls.proto\x12\x1aenvoy.service.ratelimit.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9e\x01\n" +
	"\x10RateLimitRequest\x12\x16\n" +
	"\x06domain\x18\x01 \x01(\tR\x06domain\x12Q\n" +
	"\vdescriptors\x18\x02 \x03(\v2/.envoy.service.ratelimit.v3.RateLimitDescriptorR\vdescriptors\x12\x1f\n" +
	...
	"\bstatuses\x18\x02 \x03(\v2>.envoy.service.ratelimit.v3.RateLimitResponse.DescriptorStatusR\bstatuses\x12^\n" +
	"\x17response_headers_to_add\x18\x03 \x03(\v2'.envoy.service.ratelimit.v3.HeaderValueR\x14responseHeadersToAdd\x12\\\n" +
	"\x16request_headers_to_add\x18\x04 \x03(\v2'.envoy.service.ratelimit.v3.HeaderValueR\x13requestHeadersToAdd\x12\x19\n" +
	...
	"\x05quota\x18\a \x01(\v23.envoy.service.ratelimit.v3.RateLimitResponse.QuotaR\x05quota\x1a\xfc\x01\n" +
	"\tRateLimit\x12\x12\n" +
	...
	"\x04YEAR\x10\x06\x1a\x8a\x01\n" +
	"\x05Quota\x12\x1a\n" +
	"\brequests\x18\x01 \x01(\rR\brequests\x12=\n" +
	"\vvalid_until\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\n" +
	"validUntil\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\tR\x02idB\x16\n" +
	"\x14expiration_specifier\x1a\xf9\x02\n" +
	...
	"\x05quota\x18\x05 \x01(\v23.envoy.service.ratelimit.v3.RateLimitResponse.QuotaR\x05quota\"+\n" +
	"\x04Code\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\x06\n" +
	"\x02OK\x10\x01\x12\x0e\n" +
	"\n" +
	"OVER_LIMIT\x10\x02\"R\n" +
	"\vHeaderValue\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x12\x1b\n" +
	"\traw_value\x18\x03 \x01(\fR\brawValue\"\xaf\x03\n" +
	"\x13RateLimitDescriptor\x12O\n" +
	"\aentries\x18\x01 \x03(\v25.envoy.service.ratelimit.v3.RateLimitDescriptor.EntryR\aentries\x12W\n" +
	"\x05limit\x18\x02 \x01(\v2A.envoy.service.ratelimit.v3.RateLimitDescriptor.RateLimitOverrideR\x05limit\x12=\n" +
	...
	"\x04unit\x18\x02 \x01(\x0e2).envoy.service.ratelimit.v3.RateLimitUnitR\x04unit*\\\n" +
	...
	"\x03DAY\x10\x04\x12\t\n" +
	"\x05MONTH\x10\x05\x12\b\n" +
	"\x04YEAR\x10\x062\x84\x01\n" +
	"\x10RateLimitService\x12p\n" +
	"\x0fShouldRateLimit\x12,.envoy.service.ratelimit.v3.RateLimitRequest\x1a-.envoy.service.ratelimit.v3.RateLimitResponse\"\x00BOZMgithub.com/envoyproxy/go-control-plane/envoy/service/ratelimit/v3;ratelimitv3b\x06proto3"

var (
	file_rls_proto_rawDescOnce sync.Once
	file_rls_proto_rawDescData []byte
)

func file_rls_proto_rawDescGZIP() []byte {
	file_rls_proto_rawDescOnce.Do(func() {
		file_rls_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_rls_proto_rawDesc), len(file_rls_proto_rawDesc)))
	})
	return file_rls_proto_rawDescData
}

var file_rls_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_rls_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_rls_proto_goTypes = []any{
	(RateLimitUnit)(0),                            // 0: envoy.service.ratelimit.v3.RateLimitUnit
	(RateLimitResponse_Code)(0),                   // 1: envoy.service.ratelimit.v3.RateLimitResponse.Code
	(RateLimitResponse_RateLimit_Unit)(0),         // 2: envoy.service.ratelimit.v3.RateLimitResponse.RateLimit.Unit
	(*RateLimitRequest)(nil),                      // 3: envoy.service.ratelimit.v3.RateLimitRequest
	(*RateLimitResponse)(nil),                     // 4: envoy.service.ratelimit.v3.RateLimitResponse
	(*HeaderValue)(nil),                           // 5: envoy.service.ratelimit.v3.HeaderValue
	(*RateLimitDescriptor)(nil),                   // 6: envoy.service.ratelimit.v3.RateLimitDescriptor
	(*RateLimitResponse_RateLimit)(nil),           // 7: envoy.service.ratelimit.v3.RateLimitResponse.RateLimit
	(*RateLimitResponse_Quota)(nil),               // 8: envoy.service.ratelimit.v3.RateLimitResponse.Quota
	(*RateLimitResponse_DescriptorStatus)(nil),    // 9: envoy.service.ratelimit.v3.RateLimitResponse.DescriptorStatus
	(*RateLimitDescriptor_Entry)(nil),             // 10: envoy.service.ratelimit.v3.RateLimitDescriptor.Entry
	(*RateLimitDescriptor_RateLimitOverride)(nil), // 11: envoy.service.ratelimit.v3.RateLimitDescriptor.RateLimitOverride
...
var file_rls_proto_depIdxs = []int32{
	6,  // 0: envoy.service.ratelimit.v3.RateLimitRequest.descriptors:type_name -> envoy.service.ratelimit.v3.RateLimitDescriptor
	1,  // 1: envoy.service.ratelimit.v3.RateLimitResponse.overall_code:type_name -> envoy.service.ratelimit.v3.RateLimitResponse.Code
	9,  // 2: envoy.service.ratelimit.v3.RateLimitResponse.statuses:type_name -> envoy.service.ratelimit.v3.RateLimitResponse.DescriptorStatus
	5,  // 3: envoy.service.ratelimit.v3.RateLimitResponse.response_headers_to_add:type_name -> envoy.service.ratelimit.v3.HeaderValue
	5,  // 4: envoy.service.ratelimit.v3.RateLimitResponse.request_headers_to_add:type_name -> envoy.service.ratelimit.v3.HeaderValue
	12, // 5: envoy.service.ratelimit.v3.RateLimitResponse.dynamic_metadata:type_name -> google.protobuf.Struct
	8,  // 6: envoy.service.ratelimit.v3.RateLimitResponse.quota:type_name -> envoy.service.ratelimit.v3.RateLimitResponse.Quota
	10, // 7: envoy.service.ratelimit.v3.RateLimitDescriptor.entries:type_name -> envoy.service.ratelimit.v3.RateLimitDescriptor.Entry
	11, // 8: envoy.service.ratelimit.v3.RateLimitDescriptor.limit:type_name -> envoy.service.ratelimit.v3.RateLimitDescriptor.RateLimitOverride
	13, // 9: envoy.service.ratelimit.v3.RateLimitDescriptor.hits_addend:type_name -> google.protobuf.UInt64Value
	2,  // 10: envoy.service.ratelimit.v3.RateLimitResponse.RateLimit.unit:type_name -> envoy.service.ratelimit.v3.RateLimitResponse.RateLimit.Unit
	14, // 11: envoy.service.ratelimit.v3.RateLimitResponse.Quota.valid_until:type_name -> google.protobuf.Timestamp
	1,  // 12: envoy.service.ratelimit.v3.RateLimitResponse.DescriptorStatus.code:type_name -> envoy.service.ratelimit.v3.RateLimitResponse.Code
	7,  // 13: envoy.service.ratelimit.v3.RateLimitResponse.DescriptorStatus.current_limit:type_name -> envoy.service.ratelimit.v3.RateLimitResponse.RateLimit
	15, // 14: envoy.service.ratelimit.v3.RateLimitResponse.DescriptorStatus.duration_until_reset:type_name -> google.protobuf.Duration
	8,  // 15: envoy.service.ratelimit.v3.RateLimitResponse.DescriptorStatus.quota:type_name -> envoy.service.ratelimit.v3.RateLimitResponse.Quota
	0,  // 16: envoy.service.ratelimit.v3.RateLimitDescriptor.RateLimitOverride.unit:type_name -> envoy.service.ratelimit.v3.RateLimitUnit
	3,  // 17: envoy.service.ratelimit.v3.RateLimitService.ShouldRateLimit:input_type -> envoy.service.ratelimit.v3.RateLimitRequest
	4,  // 18: envoy.service.ratelimit.v3.RateLimitService.ShouldRateLimit:output_type -> envoy.service.ratelimit.v3.RateLimitResponse
...
func file_rls_proto_init() {
	...
	file_rls_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_rls_proto_rawDesc), len(file_rls_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
