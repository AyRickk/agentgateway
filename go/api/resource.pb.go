...
func (x *FrontendPolicySpec) GetAiModels() *FrontendPolicySpec_AIModels {
	if x != nil {
		if x, ok := x.Kind.(*FrontendPolicySpec_AiModels); ok {
			return x.AiModels
		}
	}
	return nil
...
type FrontendPolicySpec_AiModels struct {
	AiModels *FrontendPolicySpec_AIModels `protobuf:"bytes,6,opt,name=ai_models,json=aiModels,proto3,oneof"`
}
...
func (*FrontendPolicySpec_AiModels) isFrontendPolicySpec_Kind() {}
...
// AIModels configuration for Gateway-level model aggregation
// Allows declaring available models at the Gateway/HTTPRoute level
type FrontendPolicySpec_AIModels struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Explicitly declared models available at this Gateway
	Models []*FrontendPolicySpec_AIModels_Model `protobuf:"bytes,1,rep,name=models,proto3" json:"models,omitempty"`
	// When true, automatically collect models from backend modelAliases
	// and merge them with explicitly declared models
	AutoCollectFromBackends bool `protobuf:"varint,2,opt,name=auto_collect_from_backends,json=autoCollectFromBackends,proto3" json:"auto_collect_from_backends,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}

func (x *FrontendPolicySpec_AIModels) Reset() {
	*x = FrontendPolicySpec_AIModels{}
	mi := &file_resource_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FrontendPolicySpec_AIModels) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FrontendPolicySpec_AIModels) ProtoMessage() {}

func (x *FrontendPolicySpec_AIModels) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[64]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FrontendPolicySpec_AIModels.ProtoReflect.Descriptor instead.
func (*FrontendPolicySpec_AIModels) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{42, 6}
}

func (x *FrontendPolicySpec_AIModels) GetModels() []*FrontendPolicySpec_AIModels_Model {
	if x != nil {
		return x.Models
	}
	return nil
...
func (x *FrontendPolicySpec_AIModels) GetAutoCollectFromBackends() bool {
	if x != nil {
		return x.AutoCollectFromBackends
	}
	return false
}
...
// Model represents an AI model available via this Gateway
type FrontendPolicySpec_AIModels_Model struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *FrontendPolicySpec_AIModels_Model) Reset() {
	*x = FrontendPolicySpec_AIModels_Model{}
	mi := &file_resource_proto_msgTypes[67]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FrontendPolicySpec_AIModels_Model) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FrontendPolicySpec_AIModels_Model) ProtoMessage() {}

func (x *FrontendPolicySpec_AIModels_Model) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[67]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FrontendPolicySpec_AIModels_Model.ProtoReflect.Descriptor instead.
func (*FrontendPolicySpec_AIModels_Model) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{42, 6, 0}
}

func (x *FrontendPolicySpec_AIModels_Model) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *FrontendPolicySpec_AIModels_Model) GetOwnedBy() string {
	if x != nil {
		return x.OwnedBy
	}
	return ""
...
func (x *FrontendPolicySpec_AIModels_Model) GetCreated() int64 {
...
// Model represents an AI model available in a backend
...
func (*BackendPolicySpec_Ai_Model) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{44, 0, 15}
}
...
const file_resource_proto_rawDesc = "" +
	...
	"\atracing\x18\x05 \x01(\v25.agentgateway.dev.resource.FrontendPolicySpec.TracingH\x00R\atracing\x12U\n" +
	"\tai_models\x18\x06 \x01(\v26.agentgateway.dev.resource.FrontendPolicySpec.AIModelsH\x00R\baiModels\x1a\xf1\x04\n" +
	"\x04HTTP\x12+\n" +
	...
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value\x1a\xfc\x01\n" +
	"\bAIModels\x12T\n" +
	"\x06models\x18\x01 \x03(\v2<.agentgateway.dev.resource.FrontendPolicySpec.AIModels.ModelR\x06models\x12;\n" +
	"\x1aauto_collect_from_backends\x18\x02 \x01(\bR\x17autoCollectFromBackends\x1a]\n" +
	"\x05Model\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x19\n" +
	"\bowned_by\x18\x02 \x01(\tR\aownedBy\x12\x1d\n" +
	"\acreated\x18\x03 \x01(\x03H\x00R\acreated\x88\x01\x01B\n" +
	"\n" +
	"\b_createdB\x06\n" +
	"\x04kind\"\x862\n" +
	...
	"\x06routes\x18\a \x03(\v2;.agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntryR\x06routes\x12M\n" +
	"\x06models\x18\b \x03(\v25.agentgateway.dev.resource.BackendPolicySpec.Ai.ModelR\x06models\x1a7\n" +
	"\aMessage\x12\x12\n" +
	...
	"\x05value\x18\x02 \x01(\x0e29.agentgateway.dev.resource.BackendPolicySpec.Ai.RouteTypeR\x05value:\x028\x01\x1a]\n" +
	"\x05Model\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x19\n" +
	"\bowned_by\x18\x02 \x01(\tR\aownedBy\x12\x1d\n" +
	"\acreated\x18\x03 \x01(\x03H\x00R\acreated\x88\x01\x01B\n" +
...
var file_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 129)
var file_resource_proto_goTypes = []any{
	...
	(*FrontendPolicySpec_AIModels)(nil),                         // 90: agentgateway.dev.resource.FrontendPolicySpec.AIModels
	(*FrontendPolicySpec_Logging_Field)(nil),                    // 91: agentgateway.dev.resource.FrontendPolicySpec.Logging.Field
	(*FrontendPolicySpec_Logging_Fields)(nil),                   // 92: agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields
	(*FrontendPolicySpec_AIModels_Model)(nil),                   // 93: agentgateway.dev.resource.FrontendPolicySpec.AIModels.Model
	...
	(*BackendPolicySpec_Ai_Model)(nil), // 142: agentgateway.dev.resource.BackendPolicySpec.Ai.Model
	(*BackendPolicySpec_McpAuthentication_ResourceMetadata)(nil), // 143: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata
	nil,                              // 144: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry
	(*AIBackend_HostOverride)(nil),   // 145: agentgateway.dev.resource.AIBackend.HostOverride
	(*AIBackend_OpenAI)(nil),         // 146: agentgateway.dev.resource.AIBackend.OpenAI
	(*AIBackend_Gemini)(nil),         // 147: agentgateway.dev.resource.AIBackend.Gemini
	(*AIBackend_Vertex)(nil),         // 148: agentgateway.dev.resource.AIBackend.Vertex
	(*AIBackend_Anthropic)(nil),      // 149: agentgateway.dev.resource.AIBackend.Anthropic
	(*AIBackend_Bedrock)(nil),        // 150: agentgateway.dev.resource.AIBackend.Bedrock
	(*AIBackend_AzureOpenAI)(nil),    // 151: agentgateway.dev.resource.AIBackend.AzureOpenAI
	...
	(*BackendReference_Service)(nil), // 154: agentgateway.dev.resource.BackendReference.Service
	(*workloadapi.Workload)(nil),     // 155: istio.workload.Workload
	(*workloadapi.Service)(nil),      // 156: istio.workload.Service
...
var file_resource_proto_depIdxs = []int32{
	...
	155, // 6: agentgateway.dev.resource.Resource.workload:type_name -> istio.workload.Workload
	156, // 7: agentgateway.dev.resource.Resource.service:type_name -> istio.workload.Service
	...
	157, // 34: agentgateway.dev.resource.Timeout.request:type_name -> google.protobuf.Duration
	157, // 35: agentgateway.dev.resource.Timeout.backend_request:type_name -> google.protobuf.Duration
	157, // 36: agentgateway.dev.resource.Retry.backoff:type_name -> google.protobuf.Duration
	...
	157, // 54: agentgateway.dev.resource.CORS.max_age:type_name -> google.protobuf.Duration
	...
	157, // 64: agentgateway.dev.resource.KeepaliveConfig.time:type_name -> google.protobuf.Duration
	157, // 65: agentgateway.dev.resource.KeepaliveConfig.interval:type_name -> google.protobuf.Duration
	...
	90,  // 71: agentgateway.dev.resource.FrontendPolicySpec.ai_models:type_name -> agentgateway.dev.resource.FrontendPolicySpec.AIModels
	6,   // 72: agentgateway.dev.resource.TrafficPolicySpec.phase:type_name -> agentgateway.dev.resource.TrafficPolicySpec.PolicyPhase
	38,  // 73: agentgateway.dev.resource.TrafficPolicySpec.timeout:type_name -> agentgateway.dev.resource.Timeout
	39,  // 74: agentgateway.dev.resource.TrafficPolicySpec.retry:type_name -> agentgateway.dev.resource.Retry
	95,  // 75: agentgateway.dev.resource.TrafficPolicySpec.local_rate_limit:type_name -> agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit
	96,  // 76: agentgateway.dev.resource.TrafficPolicySpec.ext_authz:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth
	97,  // 77: agentgateway.dev.resource.TrafficPolicySpec.authorization:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RBAC
	99,  // 78: agentgateway.dev.resource.TrafficPolicySpec.jwt:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWT
	102, // 79: agentgateway.dev.resource.TrafficPolicySpec.transformation:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy
	94,  // 80: agentgateway.dev.resource.TrafficPolicySpec.remote_rate_limit:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit
	105, // 81: agentgateway.dev.resource.TrafficPolicySpec.csrf:type_name -> agentgateway.dev.resource.TrafficPolicySpec.CSRF
	106, // 82: agentgateway.dev.resource.TrafficPolicySpec.ext_proc:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc
	60,  // 83: agentgateway.dev.resource.TrafficPolicySpec.request_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	60,  // 84: agentgateway.dev.resource.TrafficPolicySpec.response_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	62,  // 85: agentgateway.dev.resource.TrafficPolicySpec.request_redirect:type_name -> agentgateway.dev.resource.RequestRedirect
	63,  // 86: agentgateway.dev.resource.TrafficPolicySpec.url_rewrite:type_name -> agentgateway.dev.resource.UrlRewrite
	61,  // 87: agentgateway.dev.resource.TrafficPolicySpec.request_mirror:type_name -> agentgateway.dev.resource.RequestMirrors
	59,  // 88: agentgateway.dev.resource.TrafficPolicySpec.direct_response:type_name -> agentgateway.dev.resource.DirectResponse
	58,  // 89: agentgateway.dev.resource.TrafficPolicySpec.cors:type_name -> agentgateway.dev.resource.CORS
	100, // 90: agentgateway.dev.resource.TrafficPolicySpec.basic_auth:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication
	101, // 91: agentgateway.dev.resource.TrafficPolicySpec.api_key_auth:type_name -> agentgateway.dev.resource.TrafficPolicySpec.APIKey
	107, // 92: agentgateway.dev.resource.TrafficPolicySpec.host_rewrite:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HostRewrite
	120, // 93: agentgateway.dev.resource.BackendPolicySpec.a2a:type_name -> agentgateway.dev.resource.BackendPolicySpec.A2a
	121, // 94: agentgateway.dev.resource.BackendPolicySpec.inference_routing:type_name -> agentgateway.dev.resource.BackendPolicySpec.InferenceRouting
	122, // 95: agentgateway.dev.resource.BackendPolicySpec.backend_tls:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTLS
	40,  // 96: agentgateway.dev.resource.BackendPolicySpec.auth:type_name -> agentgateway.dev.resource.BackendAuthPolicy
	125, // 97: agentgateway.dev.resource.BackendPolicySpec.mcp_authorization:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthorization
	126, // 98: agentgateway.dev.resource.BackendPolicySpec.mcp_authentication:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication
	119, // 99: agentgateway.dev.resource.BackendPolicySpec.ai:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai
	60,  // 100: agentgateway.dev.resource.BackendPolicySpec.request_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	60,  // 101: agentgateway.dev.resource.BackendPolicySpec.response_header_modifier:type_name -> agentgateway.dev.resource.HeaderModifier
	62,  // 102: agentgateway.dev.resource.BackendPolicySpec.request_redirect:type_name -> agentgateway.dev.resource.RequestRedirect
	61,  // 103: agentgateway.dev.resource.BackendPolicySpec.request_mirror:type_name -> agentgateway.dev.resource.RequestMirrors
	123, // 104: agentgateway.dev.resource.BackendPolicySpec.backend_http:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendHTTP
	124, // 105: agentgateway.dev.resource.BackendPolicySpec.backend_tcp:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTCP
	153, // 106: agentgateway.dev.resource.AIBackend.provider_groups:type_name -> agentgateway.dev.resource.AIBackend.ProviderGroup
	75,  // 107: agentgateway.dev.resource.MCPBackend.targets:type_name -> agentgateway.dev.resource.MCPTarget
	23,  // 108: agentgateway.dev.resource.MCPBackend.stateful_mode:type_name -> agentgateway.dev.resource.MCPBackend.StatefulMode
	24,  // 109: agentgateway.dev.resource.MCPBackend.prefix_mode:type_name -> agentgateway.dev.resource.MCPBackend.PrefixMode
	76,  // 110: agentgateway.dev.resource.MCPTarget.backend:type_name -> agentgateway.dev.resource.BackendReference
	25,  // 111: agentgateway.dev.resource.MCPTarget.protocol:type_name -> agentgateway.dev.resource.MCPTarget.Protocol
	154, // 112: agentgateway.dev.resource.BackendReference.service:type_name -> agentgateway.dev.resource.BackendReference.Service
	76,  // 113: agentgateway.dev.resource.RequestMirrors.Mirror.backend:type_name -> agentgateway.dev.resource.BackendReference
	157, // 114: agentgateway.dev.resource.FrontendPolicySpec.HTTP.http1_idle_timeout:type_name -> google.protobuf.Duration
	157, // 115: agentgateway.dev.resource.FrontendPolicySpec.HTTP.http2_keepalive_interval:type_name -> google.protobuf.Duration
	157, // 116: agentgateway.dev.resource.FrontendPolicySpec.HTTP.http2_keepalive_timeout:type_name -> google.protobuf.Duration
	157, // 117: agentgateway.dev.resource.FrontendPolicySpec.TLS.handshake_timeout:type_name -> google.protobuf.Duration
	77,  // 118: agentgateway.dev.resource.FrontendPolicySpec.TLS.alpn:type_name -> agentgateway.dev.resource.Alpn
	4,   // 119: agentgateway.dev.resource.FrontendPolicySpec.TLS.cipher_suites:type_name -> agentgateway.dev.resource.TLSConfig.CipherSuite
	3,   // 120: agentgateway.dev.resource.FrontendPolicySpec.TLS.min_version:type_name -> agentgateway.dev.resource.TLSConfig.TLSVersion
	3,   // 121: agentgateway.dev.resource.FrontendPolicySpec.TLS.max_version:type_name -> agentgateway.dev.resource.TLSConfig.TLSVersion
	67,  // 122: agentgateway.dev.resource.FrontendPolicySpec.TCP.keepalives:type_name -> agentgateway.dev.resource.KeepaliveConfig
	92,  // 123: agentgateway.dev.resource.FrontendPolicySpec.Logging.fields:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields
	76,  // 124: agentgateway.dev.resource.FrontendPolicySpec.Tracing.provider_backend:type_name -> agentgateway.dev.resource.BackendReference
	89,  // 125: agentgateway.dev.resource.FrontendPolicySpec.Tracing.attributes:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TracingAttribute
	89,  // 126: agentgateway.dev.resource.FrontendPolicySpec.Tracing.resources:type_name -> agentgateway.dev.resource.FrontendPolicySpec.TracingAttribute
	5,   // 127: agentgateway.dev.resource.FrontendPolicySpec.Tracing.protocol:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Tracing.Protocol
	93,  // 128: agentgateway.dev.resource.FrontendPolicySpec.AIModels.models:type_name -> agentgateway.dev.resource.FrontendPolicySpec.AIModels.Model
	91,  // 129: agentgateway.dev.resource.FrontendPolicySpec.Logging.Fields.add:type_name -> agentgateway.dev.resource.FrontendPolicySpec.Logging.Field
	...
	157, // 132: agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit.fill_interval:type_name -> google.protobuf.Duration
	...
	157, // 139: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.timeout:type_name -> google.protobuf.Duration
	...
	158, // 156: agentgateway.dev.resource.TrafficPolicySpec.APIKey.User.metadata:type_name -> google.protobuf.Struct
	...
	142, // 167: agentgateway.dev.resource.BackendPolicySpec.Ai.models:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Model
	76,  // 168: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.endpoint_picker:type_name -> agentgateway.dev.resource.BackendReference
	18,  // 169: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.failure_mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.FailureMode
	19,  // 170: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.verification:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTLS.VerificationMode
	77,  // 171: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.alpn:type_name -> agentgateway.dev.resource.Alpn
	20,  // 172: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.version:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.HttpVersion
	157, // 173: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.request_timeout:type_name -> google.protobuf.Duration
	67,  // 174: agentgateway.dev.resource.BackendPolicySpec.BackendTCP.keepalive:type_name -> agentgateway.dev.resource.KeepaliveConfig
	157, // 175: agentgateway.dev.resource.BackendPolicySpec.BackendTCP.connect_timeout:type_name -> google.protobuf.Duration
	21,  // 176: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.provider:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.McpIDP
	143, // 177: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.resource_metadata:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata
	22,  // 178: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.Mode
	127, // 179: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.append:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	127, // 180: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.prepend:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	15,  // 181: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule.builtin:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BuiltinRegexRule
	16,  // 182: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.action:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ActionKind
	129, // 183: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.rules:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	76,  // 184: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.backend:type_name -> agentgateway.dev.resource.BackendReference
	57,  // 185: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.forward_header_matches:type_name -> agentgateway.dev.resource.HeaderMatch
	70,  // 186: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	133, // 187: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	130, // 188: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	131, // 189: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	133, // 190: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	130, // 191: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	131, // 192: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	132, // 193: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.openai_moderation:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	135, // 194: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.request:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	134, // 195: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.response:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
	17,  // 196: agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntry.value:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RouteType
	144, // 197: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.extra:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry
	159, // 198: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry.value:type_name -> google.protobuf.Value
	145, // 199: agentgateway.dev.resource.AIBackend.Provider.host_override:type_name -> agentgateway.dev.resource.AIBackend.HostOverride
	146, // 200: agentgateway.dev.resource.AIBackend.Provider.openai:type_name -> agentgateway.dev.resource.AIBackend.OpenAI
	147, // 201: agentgateway.dev.resource.AIBackend.Provider.gemini:type_name -> agentgateway.dev.resource.AIBackend.Gemini
	148, // 202: agentgateway.dev.resource.AIBackend.Provider.vertex:type_name -> agentgateway.dev.resource.AIBackend.Vertex
	149, // 203: agentgateway.dev.resource.AIBackend.Provider.anthropic:type_name -> agentgateway.dev.resource.AIBackend.Anthropic
	150, // 204: agentgateway.dev.resource.AIBackend.Provider.bedrock:type_name -> agentgateway.dev.resource.AIBackend.Bedrock
	151, // 205: agentgateway.dev.resource.AIBackend.Provider.azureopenai:type_name -> agentgateway.dev.resource.AIBackend.AzureOpenAI
	70,  // 206: agentgateway.dev.resource.AIBackend.Provider.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	152, // 207: agentgateway.dev.resource.AIBackend.ProviderGroup.providers:type_name -> agentgateway.dev.resource.AIBackend.Provider
...
func file_resource_proto_init() {
	...
	file_resource_proto_msgTypes[42].OneofWrappers = []any{
		...
		(*FrontendPolicySpec_AiModels)(nil),
	}
